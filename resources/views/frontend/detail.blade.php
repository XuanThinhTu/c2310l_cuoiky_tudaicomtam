...
<header class="bg-dark py-5">
    <div class="container px-4 px-lg-5 my-5">
      <div class="text-center text-white">
        <h1 class="display-4 fw-bolder">Car rental details</h1>
      </div>
    </div>
  </header>
  <!-- Section-->
        ...
        <div class="col-lg-8 mb-5">
          <div class="card h-100">
            ...
            <div class="card-body card-body-custom pt-4">
              <div>
                <!-- Product name-->
                <h3 class="fw-bolder text-primary">Describe</h3>
                <p>
                    Thank you very much.
                    So the pain of the corrupt does not come from anyone
                    It is easy to do other things worthy of those joys
                    the result?
                </p>
            ...
            <div class="card-footer border-top-0 bg-transparent">
              <div class="text-center">
                <a
                  ...
                  >Car Rental <i class="ri-whatsapp-line"></i
                ></a>
              </div>
            </div>
          </div>
