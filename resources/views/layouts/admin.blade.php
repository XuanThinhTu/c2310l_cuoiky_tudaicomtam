...
<body id="page-top">
    ...
    <script src="{{ asset('backemd/vendor/jquery-easing/jquery.easing.min.js') }}"></script>

    <!-- Custom scripts for all pages-->
    <script src="{{ asset('backemd/js/sb-admin-2.min.js') }}"></script>

    <!-- Page level plugins -->
    <script src="{{ asset('backemd/vendor/chart.js/Chart.min.js') }}"></script>
</body>
